...
export function NewsletterForm({ isDark }: NewsletterFormProps) {
  ...
  return (
    <div className={`flex w-full flex-col gap-4 ${isDark ? "text-white" : "text-gray-900"}`}>
      {step === "email" && (
        <div className="flex w-full flex-col items-start gap-4">
          <div className="flex items-center gap-2 text-sm leading-snug">
            <Mail className="h-4 w-4 text-red-500" />
            <span>Güncel teknoloji haberlerini kaçırmamak için abone olun.</span>
          </div>
          ...
          <div className="flex w-full flex-col gap-3">
            <div className="w-full">
              <input
                ...
                className={`w-full rounded-lg border px-3 py-2 text-sm transition-colors focus:border-red-500 focus:outline-none ${
                  isDark
                    ? "border-gray-600 bg-[#2A2C2C] text-white placeholder-gray-400"
            ...
            <button
              ...
              className="clickable w-full rounded-lg bg-red-600 px-4 py-2 text-center text-sm font-medium text-white transition-colors hover:bg-red-700"
            >
              Devam Et
            </button>
          </div>
        ...
        <div className="flex w-full flex-col gap-4">
          ...
          <div className="grid w-full gap-2 sm:grid-cols-3 sm:gap-3">
            <input
              ...
              className={`w-full rounded border px-3 py-2 text-sm transition-colors focus:border-red-500 focus:outline-none ${
                isDark
                  ? "border-gray-600 bg-[#2A2C2C] text-white placeholder-gray-400"
                  : "border-gray-300 bg-white text-gray-900 placeholder-gray-500"
              }`}
